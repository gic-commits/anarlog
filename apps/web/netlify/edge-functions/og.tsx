    ...
    return (
      ...
      >
        ...
        <img
          ...
          src="https://char.com/api/assets/icons/nightly-icon.png"
        />
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <img
        ...
        src="https://char.com/api/assets/icons/stable-icon.png"
      />
    </div>
  );
}
...
const AUTHOR_AVATARS: Record<string, string> = {
  "John Jeong": "https://char.com/api/assets/team/john.png",
  "Yujong Lee": "https://char.com/api/assets/team/yujong.png",
  Harshika: "https://char.com/api/assets/team/harshika.jpeg",
};

function getAuthorAvatar(author: string): string {
  return (
    AUTHOR_AVATARS[author] ||
    "https://char.com/api/assets/icons/stable-icon.png"
  );
}

...
**ElevenLabs** - High-quality real-time transcription. [Privacy Policy](https://elevenlabs.io/privacy-policy)

**DashScope** - Alibaba Cloud's Qwen3-ASR real-time speech recognition. [Privacy Policy](https://www.alibabacloud.com/help/en/legal/latest/Chinese-mainland-chinese-version-Chinese-mainland-chinese-version)

**Mistral** - Voxtral audio transcription models. [Privacy Policy](https://mistral.ai/terms/#privacy-policy)

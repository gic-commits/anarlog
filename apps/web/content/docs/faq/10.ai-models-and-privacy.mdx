...
Char supports multiple cloud-based STT providers for transcription. See the cloud providers section below for details.
...
See our [Local LLM Setup guide](/docs/faq/local-llm-setup) for instructions on configuring LM Studio or Ollama with Char.

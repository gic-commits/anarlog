...
Char is currently available for **macOS** (Apple Silicon and Intel). Windows and Linux are planned for **Q2 2026**. Follow our [GitHub](https://github.com/charapp/char) or [changelog](/changelog) for updates.

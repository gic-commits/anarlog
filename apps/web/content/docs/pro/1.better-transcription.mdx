...
For local STT model details and manual download instructions, see [Local Models](/docs/developers/local-models). To understand how your data is handled, see [AI Models & Data Privacy](/docs/faq/ai-models-and-privacy).

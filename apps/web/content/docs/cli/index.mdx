...
- `--provider <PROVIDER>`
- `--model <MODEL>` — Model name (API model for cloud providers, model ID for local)
- `--model-path <MODEL_PATH>` — Path to a local model directory on disk

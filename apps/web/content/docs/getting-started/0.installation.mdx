...
- [AppImage (x86_64)](https://desktop2.char.com/download/latest/appimage-x86_64?channel=nightly) - run `chmod +x` first
- [Debian Package (x86_64)](https://desktop2.char.com/download/latest/deb-x86_64?channel=nightly) - install with `sudo dpkg -i`

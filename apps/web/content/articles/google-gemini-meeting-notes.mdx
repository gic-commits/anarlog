...
- **Local-first privacy.** Hyprnote is a [local AI notepad](/product/local-ai) that uses on-device AI models to transcribe and summarize meetings without sending data to the cloud.
...
Yes - Hyprnote is a completely [free AI note taker](/blog/free-ai-notetakers) that works with Google Meet, Zoom, Teams, and any other meeting platform.

...
Everything is stored as plain markdown files—not in proprietary databases. You choose your AI stack: managed cloud, bring your own keys, or run local models. Zero lock-in reduces your compliance surface area and simplifies HIPAA, GDPR, and SOC 2 compliance requirements.

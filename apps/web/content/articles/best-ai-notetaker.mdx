...
| ------------- | ----------------------------------- | ------------------------------------- | ------------------------------------------ |
| Char      | macOS                               | Zero lock-in, complete control        | Free forever (local + BYOK). Cloud $8/mo   |
...
Char is free forever for local transcription, BYOK, and all core features. Managed cloud service is $8/month for the easiest setup without managing API keys.

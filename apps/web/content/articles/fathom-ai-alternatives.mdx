...
Anarlog is an open-source AI notepad for meetings. Everything is stored as plain markdown files on your device—not in proprietary databases. You choose which AI processes your data: managed cloud, bring your own API keys, or run local models.
...
- Cloud-only processing—no on-premises option like Anarlog

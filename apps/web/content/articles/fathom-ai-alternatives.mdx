...
Full disclosure—I'm the co-founder of [Char](/). I built it because every other tool I looked at handled user data in ways I couldn't defend.

Everything stays on your Mac. Your conversations never leave your computer. Char uses local AI models (a custom 1.1GB model called HyperLLM-V1) that run entirely on-device.
...
**Best For:** Healthcare providers, legal professionals, financial advisors, government agencies, therapists, and anyone handling confidential conversations where data sovereignty is non-negotiable.
...
- No AI training on your data—it doesn't happen, period
...
Free forever for core features. Unlimited transcription, unlimited AI summaries, no usage caps. Pro is $8/month for unlimited AI chat and custom templates. Enterprise pricing covers on-prem deployment, smart consent management, and SSO—[contact sales for a quote](/founders).
...
**If privacy matters, use Char.** Nothing else keeps your data truly private. Healthcare, legal, therapy, financial planning—anywhere conversations are confidential, this is the only real choice. You also get real-time transcription and offline support that Fathom can't match.

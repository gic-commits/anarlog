...
Free forever for local transcription, BYOK, and all core features. No usage caps, no artificial limits. Managed cloud service is $8/month for the easiest setup. Enterprise pricing covers on-prem deployment, smart consent management, and SSO—[contact sales for a quote](/founders).

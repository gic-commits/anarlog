...
| --------- | -------------------------------------------- | ------------------------- |
| Char  | Zero lock-in, complete control               | Free forever (local + BYOK). Cloud: $8/mo |
...
- **English-optimized summaries** means that while transcription supports all languages, HyperLLM-V1 summarization performs best with English content

#### Pricing

Char's core features, including unlimited AI summaries and transcription, are **free forever**.

Free forever for local transcription, BYOK, and all core features. **Managed cloud ($8/month)** for the easiest setup.

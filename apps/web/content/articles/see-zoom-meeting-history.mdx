...
Anarlog is an open-source [AI notepad](/) for meetings that gives you complete control over your data and AI stack. Instead of just logging when meetings happened, it captures what actually occurred—stored as plain markdown files with zero lock-in.

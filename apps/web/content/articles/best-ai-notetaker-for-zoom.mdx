...
[Hyprnote](/) is the only truly [local AI notetaker](/product/local-ai) on this list. While other tools (even the [bot-free notetakers](/blog/bot-free-ai-meeting-assistants)) send your data to third-party cloud servers for processing, Hyprnote keeps everything on your device.
...
- [Free forever AI notetaker](/blog/free-ai-notetakers) (not a trial that expires)
...
Hyprnote also offers an Enterprise plan for organizations that need an on-premise deployment, SSO integration, or smart consent management for compliance requirements. [Contact sales for a quote](/founders).
...
Users have reported that the bot sometimes joins meetings without proper consent and spams all participants with meeting notes. There's currently an [ongoing class-action lawsuit](/blog/is-otter-ai-safe) regarding these privacy practices.
...
[Download Hyprnote for macOS](/download) to experience meeting intelligence that costs nothing and compromises nothing (iOS app and Windows version coming soon!).

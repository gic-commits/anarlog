...
- **Char** → Privacy-conscious teams needing complete data control
...
[Char](/) is the only truly [local AI notetaker](/product/local-ai) on this list. While other tools (even the [bot-free notetakers](/blog/bot-free-ai-meeting-assistants)) send your data to third-party cloud servers for processing, Char keeps everything on your device.
...
If local processing and complete privacy matter for your meetings, Char might be the best AI notetaker for you. Here's what you get with Char:

- **Universal Platform Compatibility** - Unlike Zoom AI Companion that only works within Zoom, Char works with all meeting platforms and captures audio from any source on your device.
...
[Download Char for macOS](/download) to experience meeting intelligence that costs nothing and compromises nothing (iOS app and Windows version coming soon!).

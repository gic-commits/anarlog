...
[Anarlog](/) is an open-source AI notepad for meetings built for high-agency people who demand complete control. Everything is stored as plain markdown files on your device—not in proprietary databases. You choose your AI stack: managed cloud, bring your own keys, or run local models.

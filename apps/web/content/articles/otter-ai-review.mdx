...
| [Anarlog](anarlog.so) | Zero lock-in, complete control    | Free forever (local + BYOK). Cloud $25/month     | Open source. Plain markdown. Your choice of AI. |
...
Anarlog is the best Otter AI alternative if you want zero lock-in and complete control. It's an open-source AI notepad that stores everything as plain markdown files and lets you choose your AI stack—managed cloud, bring your own keys, or run local models. Zero vendor lock-in, zero compromises.

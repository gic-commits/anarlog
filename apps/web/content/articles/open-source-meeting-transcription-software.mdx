...
Core features (unlimited transcription, AI summaries) are free. Pro adds advanced search and unlimited AI chat at $8/month. Enterprise offers on-premises deployment.
...
Yes, all three are open source. Char and Amical are free for all users. Char includes an optional Pro tier ($8/month) and Enterprise tier (custom pricing), but core transcription and summarization remain free.

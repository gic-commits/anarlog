...
[Hyprnote](/) is the only open-source, truly [local AI meeting assistant](/product/local-ai) that gives you complete transparency and control over your meeting data.

...
[Char](/) is an open-source, [local AI meeting assistant](/product/local-ai) that keeps all meeting data on your device instead of sending it to cloud providers.

You can inspect the code, customize functionality, and verify exactly how your conversations are processed. Everything stays local on your device.
...
You take notes, the AI enhances them with transcript insights, and you get polished summaries. The difference is where that processing happens. With Char, everything stays on your device. Granola sends your meetings to OpenAI and Anthropic.
...
Each alternative has distinct strengths. Char offers a unique value proposition: complete data sovereignty. Your conversations never leave your device, and you can inspect the code to verify how everything works.
...
For teams in healthcare, legal, finance, or any industry where confidentiality matters, Char offers a different approach to how sensitive conversations should be handled with AI.

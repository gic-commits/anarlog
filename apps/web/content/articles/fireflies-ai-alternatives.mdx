...
| --------- | -------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------ |
| Char  | Zero lock-in, complete control over data and AI stack    | Free forever (local + BYOK). Cloud: $8/mo         | All platforms (system audio capture) + in-person |
...
Char is free forever for local transcription, BYOK, and all core features. The managed cloud service is $8/month for those who want the easiest setup. Enterprise plans include on-premises deployment, SSO integration, and consent management for compliance requirements. Contact sales for a quote.

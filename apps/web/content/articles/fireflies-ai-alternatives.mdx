...
Fireflies processes everything in the cloud and uses a bot to join meetings. Char keeps all data on your Mac and captures system audio directly. You get meeting intelligence without any privacy risks or cloud dependency.

#### Top Features

- Everything happens on your device (nothing leaves your Mac)
...
Char is free, so you'll likely never need to pay for core features. The Pro plan ($8/month) adds unlimited everything and advanced features like custom templates. Enterprise plans include on-premises deployment, SSO integration, and consent management for compliance requirements. Contact sales for a quote.
...
If local processing and complete privacy matter for your meetings, Char might be the best Fireflies alternative for you. Char offers:

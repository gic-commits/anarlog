...
Use Char to automatically capture the entire conversation. It runs locally on your device, processing everything on-device without any data leaving your machine—critical for sensitive conversations about performance, compensation, or personal issues. No bot joins your call. No transcripts sent to the cloud.

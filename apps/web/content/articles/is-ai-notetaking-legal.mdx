...
Char works differently. You decide how your data is processed — local models on your device, your own cloud API keys, or Char's managed service. Everything saves as plain markdown files on your device, and IT teams can audit the open-source code. When you control the stack, you control the compliance surface.

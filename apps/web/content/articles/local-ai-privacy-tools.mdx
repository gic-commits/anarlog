...
At [Anarlog](/), we're building an open-source AI notepad for meetings that gives you complete control. Everything is stored as plain markdown files. You choose your AI stack—managed cloud, bring your own keys, or run local models. Zero lock-in, zero compromises.

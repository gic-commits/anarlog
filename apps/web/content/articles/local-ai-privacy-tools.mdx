...
At [Char](/), we're building a privacy-first AI notetaker that runs fully on-device. Transcription, summarization, everything runs on local AI. Nothing is sent to the cloud. No audio, no text, no metadata.
...
Cloud-first AI is colliding with growing demand for local-first privacy. As more workflows get automated and augmented by AI, the need for trustworthy, transparent, on-device solutions will only grow.

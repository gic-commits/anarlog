...
author: "John Jeong"
created: "2025-07-28"
coverImage: "https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/public_images/blog/local-ai-privacy-tools/cover.png"
---
...
<img src="https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/public_images/blog/local-ai-privacy-tools/your-data-is-wanted.png" alt="Your data is wanted by everyone"/>

## Where Hyprnote Comes In

At [Hyprnote](https://hyprnote.com), we're building a privacy-first AI notetaker that runs fully on-device. From transcription to summarization, every part of the experience is powered by local AI. Nothing is sent to the cloud. No audio, no text, no metadata.

...
The managed cloud service at $8/month adds the easiest setup without managing API keys, plus unlimited chat with your notes, custom templates, and advanced features.

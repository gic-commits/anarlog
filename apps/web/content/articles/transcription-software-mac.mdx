...
[Char](/) is a local-first transcription tool built specifically for Mac. Everything happens on your device using OpenAI's Whisper models. Your data stays on your Mac.

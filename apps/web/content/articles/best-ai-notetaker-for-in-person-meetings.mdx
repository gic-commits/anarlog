...
[Char](/) is the only [local AI notetaker](/product/local-ai) available in the market. Competitors like Otter, Fireflies, and [other tools](/blog/bot-free-ai-meeting-assistants) send your conversations to the cloud. Char processes everything locally on your Mac using Whisper models for speech-to-text (ranging from Tiny to V3 Large Turbo) and their custom HyperLLM-V1 for summaries.
...
Your sensitive client conversations, therapy sessions, or legal discussions never leave your device unless you explicitly choose to connect to external APIs.
...
- Includes a forever-free plan with unlimited AI summaries
...
If local processing and complete privacy matter for your meetings, Char handles what other tools can't. You get:

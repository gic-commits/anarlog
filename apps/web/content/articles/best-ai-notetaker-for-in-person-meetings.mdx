...
[Hyprnote](/) is the only [local AI notetaker](/product/local-ai) available in the market. While competitors like Otter, Fireflies, and even ["bot-free" tools](/blog/bot-free-ai-meeting-assistants) like Jamie AI send your conversations to the cloud, Hyprnote processes everything locally on your Mac. It uses Whisper models for speech-to-text (ranging from Tiny to V3 Large Turbo) and their custom HyperLLM-V1 for summaries.

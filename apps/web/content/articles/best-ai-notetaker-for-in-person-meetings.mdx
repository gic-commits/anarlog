...
[Anarlog](/) is an open-source AI notepad for meetings built for high-agency people who demand complete control over their data and AI stack. Everything is stored as plain markdown files—not in proprietary databases. You choose your AI: managed cloud, bring your own keys, or run local models.
...
Anarlog also offers an Enterprise plan for organizations that need on-premise deployment, SSO integration, or smart consent management for compliance requirements. [Contact sales for a quote](/founders).

...
Most transcription software forces you into their cloud, their servers, their rules. **[Char](http://char.com)** is an open-source AI note-taker that stores your data locally and gives you complete control over the AI stack.
...
Char stands out if you value both functionality and control.

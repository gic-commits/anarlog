...
[Anarlog](/) is an open-source AI notepad for meetings that gives you complete control over your data and AI stack. Everything is stored as plain markdown files—not in proprietary databases. You choose your AI: managed cloud, BYOK, or run local models.
...
Ready to take control of your transcription data? **[Download Anarlog for macOS](/download)** and get unlimited private transcription (Windows and Linux versions coming in Q2 2026).

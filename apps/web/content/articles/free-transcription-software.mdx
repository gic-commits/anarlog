...
[Char](/) is a local-first transcription tool that processes everything on your device. Most tools send your audio to cloud servers. Char's Whisper-powered transcription engine runs locally, which means no surveillance capitalism business models or data privacy compromises.

This local processing approach eliminates third-party vendor dependencies and keeps sensitive data on-device, simplifying HIPAA, GDPR, and SOC 2 compliance requirements.
...
The core transcription features stay free forever. Upgrade to Pro ($8/month) if you want unlimited AI chat with your transcripts, custom template building, or advanced search capabilities.
...
Unlike most transcription tools that send your audio to cloud servers, Char processes everything on your device using local AI models. Your data stays on your machine.

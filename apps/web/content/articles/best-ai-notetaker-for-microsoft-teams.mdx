...
Char is a [local-first AI notepad](/product/local-ai) designed specifically for compliance-sensitive organizations and privacy-conscious professionals. Everything processes locally using on-device AI models, so your meeting data never leaves your machine.
...
- Keeps data on-device for simple compliance
...
Char is a [free AI notetaker](/blog/free-ai-notetakers). You'll likely never need to pay for core features. The Pro plan ($8/month) adds unlimited everything and advanced features like custom templates. Enterprise applies when your organization needs on-premises deployment, SSO integration, or consent management for compliance requirements. [Contact sales for a quote](/founders).
...
If local processing and complete privacy matter for your meetings, Char might be the best AI notetaker for Microsoft Teams. You get:

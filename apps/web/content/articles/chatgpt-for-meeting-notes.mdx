...
Char is a [local-first AI notetaker](/product/local-ai) that keeps all your data on your device. It uses local AI models to transcribe your calls in real-time and generate instant summaries without sending data to the cloud. This reduces compliance surface area and third-party data exposure.
...
Char provides unlimited AI summaries and all core features free forever. You can upgrade to Pro ($8/month) only when you need unlimited advanced functionality.

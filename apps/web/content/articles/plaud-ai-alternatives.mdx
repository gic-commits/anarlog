...
[Char](/) is an open-source AI notepad for meetings built for high-agency people who demand complete control over their data and AI stack. Everything is stored as plain markdown files—no hardware to carry, no vendor lock-in.
...
- **Your choice of AI stack**: Managed cloud service, bring your own API keys, or run local models
...
- **Free forever**: Local transcription, BYOK, and all core features at no cost
- **Works offline**: Take notes, record, and transcribe without internet connectivity
- **Open-source**: Inspect the code, contribute, or customize it for your needs—zero vendor lock-in
...
- Your choice of AI stack—managed cloud ($8/mo), BYOK, or run fully local (vs Plaud requiring their cloud)
- True file ownership—works with any tool (vs Plaud's proprietary app)
...
The managed cloud service is $8/month for those who want the easiest setup without managing API keys. Most people never need to pay—the free plan handles meeting notes completely.

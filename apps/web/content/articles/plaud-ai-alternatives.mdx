...
[Char](/) is a privacy-first AI notepad that runs entirely on your Mac. No hardware to carry, no cloud required, and your data stays on your device.
...
- Zero cloud dependency. Works offline, on flights, anywhere (vs Plaud requiring cloud for AI features)
...
Char flips the typical pricing model. Everything that matters—unlimited transcription, unlimited AI summaries, real-time recording—is completely free. Forever.

Pro ($20/month) adds unlimited chat with your notes, unlimited custom templates, and workflow automation. Most people never need to upgrade. The free plan handles meeting notes without the pressure to pay for features.

Enterprise pricing applies when you need on-prem deployment, SSO, consent management, or admin controls for compliance-sensitive environments. [Contact sales](/founders) for custom quotes, but the base product remains free for individual use.

...
- Experimental in-meeting-reminder notification - opt-in in lab settings, notifies when another app has been using your microphone for 3+ minutes while Hyprnote isn't listening

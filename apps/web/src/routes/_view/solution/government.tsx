      ...
      <div className="px-6 py-12 lg:py-20">
        <header className="mb-8 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto">
            Capture public meetings and policy discussions with AI that processes everything
            locally. Your sensitive data stays on your secure infrastructure.
          </p>
    ...
    <section className="px-6 py-16 border-t border-neutral-100">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-neutral-600 mb-8">
          Join government agencies who are improving meeting documentation while maintaining
          security.
        </p>
        <Link
          to="/download"

      ...
      <div className="px-6 py-12 lg:py-20">
        <header className="mb-8 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto">
            Capture clinical meetings and patient discussions with AI that processes everything
            locally. Your patient data never leaves your device.
          </p>
    ...
    <section className="px-6 py-16 border-t border-neutral-100">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-neutral-600 mb-8">
          Join healthcare teams who are saving time on documentation while maintaining patient
          privacy.
        </p>
        <Link
          to="/download"

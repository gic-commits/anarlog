...
export const Route = createFileRoute("/_view/product/search")({
  ...
  head: () => ({
    meta: [
      { title: "Searchable Notes - Hyprnote" },
      {
        name: "description",
        content:
          "Find any note, meeting, or conversation instantly with powerful full-text search across all your content.",
      },
        ...
        <div className="flex-1 bg-[linear-gradient(to_bottom,rgba(245,245,244,0.2),white_50%,rgba(245,245,244,0.3))] px-6 py-12 flex items-center justify-center relative z-10">
          <div className="text-center max-w-4xl mx-auto pointer-events-auto">
            ...
            <p className="text-lg sm:text-xl text-neutral-600 mb-8 max-w-2xl mx-auto">
              Find any note, meeting, or conversation instantly. Hyprnote's
              powerful search lets you locate information across all your
              content in seconds.
            </p>

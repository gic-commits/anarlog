          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 border-2 border-stone-300 rounded-lg bg-white">
                <Icon icon="mdi:robot-off" className="text-3xl text-stone-600 mb-4" />
                <h3 className="text-xl font-serif text-stone-600 mb-2">No bots, no interruptions</h3>
                <p className="text-neutral-600 mb-4">
                  Unlike other AI notetakers, Hyprnote doesn't send bots to join your meetings. Record directly from
                  your device for seamless, unobtrusive capture.
                </p>
              ...
              <div className="p-6 border-2 border-stone-300 rounded-lg bg-white">
                ...
                <h3 className="text-xl font-serif text-stone-600 mb-2">Local-first AI processing</h3>
                <p className="text-neutral-600 mb-4">
                  All your data stays on your device. AI processes recordings locally with no cloud uploads or
                  third-party servers.
                </p>
                <ul className="space-y-2 text-sm text-neutral-600">
                  <li className="flex items-start gap-2">
                    <Icon icon="mdi:check" className="text-green-600 shrink-0 mt-0.5" />
                    <span>Complete privacy - data never leaves your computer</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon icon="mdi:check" className="text-green-600 shrink-0 mt-0.5" />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 bg-red-50 border-2 border-red-200 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-serif text-lg text-red-900">Bot-based Services</h3>
                </div>
                <ul className="space-y-3 text-sm text-red-900">
                  <li className="flex items-start gap-2">
                    <Icon icon="mdi:close" className="text-red-600 shrink-0 mt-0.5" />
              ...
              <div className="p-6 bg-green-50 border-2 border-green-200 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-serif text-lg text-green-900">Hyprnote Notepad</h3>
                </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-serif text-stone-600 mb-2">Compliance-ready</h3>
                  <p className="text-neutral-600">
                    Meet GDPR, HIPAA, and other data protection requirements by keeping sensitive conversations entirely
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Eliminate the risk of data breaches, unauthorized access, or third-party data mining. Your data
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Maintain complete ownership and control. Export, backup, or delete your data anytime without
                    requesting access from a service provider.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">
                    Your data isn't trapped in a proprietary cloud system. It's stored in standard formats on your
                    device.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                ...
                <h3 className="font-medium text-stone-600 mb-2">Confidential discussions</h3>
                <p className="text-sm text-neutral-600">
                  Keep sensitive business conversations private without third-party bots listening in.
                </p>
              </div>
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                <Icon icon="mdi:gavel" className="text-2xl text-stone-600 mb-3" />
                <h3 className="font-medium text-stone-600 mb-2">Legal consultations</h3>
                <p className="text-sm text-neutral-600">
                  Record attorney-client conversations without privacy concerns or compliance issues.
                </p>
              </div>
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                <Icon icon="mdi:hospital-box" className="text-2xl text-stone-600 mb-3" />
                <h3 className="font-medium text-stone-600 mb-2">Healthcare meetings</h3>
                <p className="text-sm text-neutral-600">
              ...
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                ...
                <h3 className="font-medium text-stone-600 mb-2">HR discussions</h3>
                <p className="text-sm text-neutral-600">
              ...
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                ...
                <h3 className="font-medium text-stone-600 mb-2">Client calls</h3>
                <p className="text-sm text-neutral-600">
              ...
              <div className="p-6 border border-neutral-200 rounded-lg bg-white">
                ...
                <h3 className="font-medium text-stone-600 mb-2">Creative sessions</h3>
                <p className="text-sm text-neutral-600">

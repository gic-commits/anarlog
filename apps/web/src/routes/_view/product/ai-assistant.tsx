      ...
      <div className="border-t border-neutral-100">
        <div className="grid md:grid-cols-2">
          <div className="p-8 border-b md:border-b-0 md:border-r border-neutral-100">
            ...
            <h3 className="text-xl font-serif text-stone-600 mb-3">Deep research with chat</h3>
            <p className="text-neutral-600 mb-4 leading-relaxed">
              Chat with your AI assistant to learn more about the people you're meeting with. Search
              through past conversations, extract key insights, and understand context before you
              join.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Icon icon="mdi:check" className="text-stone-600 shrink-0 mt-0.5" />
          ...
          <div className="p-8 border-b md:border-b-0 border-neutral-100">
            <Icon icon="mdi:file-document-edit" className="text-3xl text-stone-600 mb-4" />
            <h3 className="text-xl font-serif text-stone-600 mb-3">Generate custom templates</h3>
            <p className="text-neutral-600 mb-4 leading-relaxed">
              Create tailored meeting templates on the spot. Ask your AI assistant to generate
              agendas, question lists, or note structures specific to your meeting type.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Icon icon="mdi:check" className="text-stone-600 shrink-0 mt-0.5" />
        ...
        <div className="p-8 border-t border-neutral-100">
          <Icon icon="mdi:message-question" className="text-3xl text-stone-600 mb-4" />
          <h3 className="text-xl font-serif text-stone-600 mb-3">Ask about past conversations</h3>
          <p className="text-neutral-600 leading-relaxed max-w-3xl">
            Query your entire conversation history to refresh your memory. Find decisions, action
            items, or specific topics discussed in previous meetings—all in natural language.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="border-t border-neutral-100">
        <div className="grid md:grid-cols-2">
          <div className="p-8 border-b md:border-b-0 md:border-r border-neutral-100">
            ...
            <h3 className="text-xl font-serif text-stone-600 mb-3">Ask questions in realtime</h3>
            <p className="text-neutral-600 leading-relaxed">
              Type questions to your AI assistant during the meeting without interrupting the
              conversation. Get instant answers from the current transcript and past meeting
              context.
            </p>
          </div>

          <div className="p-8 border-b md:border-b-0 border-neutral-100">
            <Icon icon="mdi:lightbulb-on" className="text-3xl text-stone-600 mb-4" />
            ...
            <p className="text-neutral-600 mb-4 leading-relaxed">
              AI-powered extensions provide live assistance during your meeting. Built on our
              extension framework, these tools adapt to your needs in realtime.
            </p>
          </div>
        </div>
          ...
          <div className="py-8 px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-stone-50 border border-neutral-200 rounded-lg">
                <Icon icon="mdi:comment-check" className="text-2xl text-stone-600 mb-3" />
                <h5 className="font-medium text-stone-700 mb-2">Suggestions</h5>
                <p className="text-sm text-neutral-600">
                  Get AI-generated advice and recommendations based on the conversation flow
                </p>
              </div>

              <div className="p-6 bg-stone-50 border border-neutral-200 rounded-lg">
                <Icon icon="mdi:account-voice" className="text-2xl text-stone-600 mb-3" />
                <h5 className="font-medium text-stone-700 mb-2">Talk time tracking</h5>
                <p className="text-sm text-neutral-600">
                  Monitor who's speaking and for how long to ensure balanced participation
                </p>
              </div>

              <div className="p-6 bg-stone-50 border border-neutral-200 rounded-lg">
                <Icon icon="mdi:school" className="text-2xl text-stone-600 mb-3" />
                <h5 className="font-medium text-stone-700 mb-2">ELI5 explanations</h5>
                <p className="text-sm text-neutral-600">
                  Get instant simple explanations of technical or professional jargon
                </p>
              </div>
            </div>
  ...
  return (
    <section id="after-meeting">
      ...
      <div className="border-t border-neutral-100">
        <div className="grid md:grid-cols-2">
          <div className="p-8 border-b md:border-b-0 md:border-r border-neutral-100">
            <Icon icon="mdi:workflow" className="text-3xl text-stone-600 mb-4" />
            <h3 className="text-xl font-serif text-stone-600 mb-3">
              Execute workflows with natural language
            </h3>
            <p className="text-neutral-600 mb-4 leading-relaxed">
              Describe what you want to do, and let your AI assistant handle the rest. Automate
              follow-up tasks across your tools without manual data entry.
            </p>
            <div className="space-y-3">
              <div className="p-4 bg-stone-50 border border-neutral-200 rounded-lg">
                <p className="text-sm text-neutral-700 italic mb-2">
                  "Add a Linear ticket for the mobile UI bug we discussed and assign it to Sarah"
                </p>
              ...
              <div className="p-4 bg-stone-50 border border-neutral-200 rounded-lg">
                <p className="text-sm text-neutral-700 italic mb-2">
                  "Send the summary to the #engineering channel and mark the Q4 roadmap item as
                  done"
                </p>
                <p className="text-xs text-neutral-500">
              ...
              <div className="p-4 bg-stone-50 border border-neutral-200 rounded-lg">
                <p className="text-sm text-neutral-700 italic mb-2">
                  "Schedule follow-up meeting with the client for next week and add action items to
                  Notion"
                </p>
                <p className="text-xs text-neutral-500">✓ Creates calendar event and syncs tasks</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 border-b md:border-b-0 border-neutral-100">
            ...
            <p className="text-neutral-600 leading-relaxed">
              Your AI assistant builds memory from your interactions. It remembers preferences,
              learns from edits you make to summaries, and continuously improves its assistance
              based on your patterns.
            </p>
            <ul className="space-y-3 mt-4">
              <li className="flex items-start gap-3">
                <Icon icon="mdi:check-circle" className="text-stone-600 shrink-0 mt-0.5" />
                <span className="text-sm text-neutral-600">
  ...
  return (
    <section className="py-16 bg-linear-to-t from-stone-50/30 to-stone-100/30 px-4 lg:px-0">
      <div className="flex flex-col gap-6 items-center text-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-serif">Start using your AI assistant</h2>
        <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
          Get AI-powered help before, during, and after every meeting with Hyprnote
        </p>

...
import installer from "./NativeMobile";
...
export * from "./../generated/mobile_bridge";

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as mobile_bridge from "./../generated/mobile_bridge";
...
if (!initialized) {
  mobile_bridge.default.initialize();
  initialized = true;
}

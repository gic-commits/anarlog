...
import {
  ...
  putActive,
  getCommands,
  postCommandsByCommandId,
  getObsidianLocalRestApiCrt,
  postOpenByFilename,
  getOpenapiYaml,
  deletePeriodicByPeriod,
  getPeriodicByPeriod,
  patchPeriodicByPeriod,
  postPeriodicByPeriod,
  putPeriodicByPeriod,
  deletePeriodicByPeriodByYearByMonthByDay,
  getPeriodicByPeriodByYearByMonthByDay,
  patchPeriodicByPeriodByYearByMonthByDay,
  postPeriodicByPeriodByYearByMonthByDay,
  putPeriodicByPeriodByYearByMonthByDay,
  postSearch,
  postSearchSimple,
  getVault,
  deleteVaultByFilename,
  getVaultByFilename,
  patchVaultByFilename,
  postVaultByFilename,
  putVaultByFilename,
  getVaultByPathToDirectory,
} from "../sdk.gen";
...
export const postCommandsByCommandIdMutation = (
  options?: Partial<Options<PostCommandsByCommandIdData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostCommandsByCommandIdResponse,
    PostCommandsByCommandIdError,
    Options<PostCommandsByCommandIdData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postCommandsByCommandId({
        ...options,
...
export const getObsidianLocalRestApiCrtQueryKey = (
  options?: Options<GetObsidianLocalRestApiCrtData>,
) => createQueryKey("getObsidianLocalRestApiCrt", options);

export const getObsidianLocalRestApiCrtOptions = (
  options?: Options<GetObsidianLocalRestApiCrtData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postOpenByFilenameMutation = (options?: Partial<Options<PostOpenByFilenameData>>) => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DefaultError,
    Options<PostOpenByFilenameData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postOpenByFilename({
        ...options,
...
export const getOpenapiYamlQueryKey = (options?: Options<GetOpenapiYamlData>) =>
  createQueryKey("getOpenapiYaml", options);

export const getOpenapiYamlOptions = (options?: Options<GetOpenapiYamlData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const deletePeriodicByPeriodMutation = (
  options?: Partial<Options<DeletePeriodicByPeriodData>>,
) => {
  const mutationOptions: UseMutationOptions<
    DeletePeriodicByPeriodResponse,
    DeletePeriodicByPeriodError,
    Options<DeletePeriodicByPeriodData>
  > = {
    mutationFn: async (localOptions) => {
...
export const patchPeriodicByPeriodMutation = (
  options?: Partial<Options<PatchPeriodicByPeriodData>>,
) => {
  const mutationOptions: UseMutationOptions<
    unknown,
    PatchPeriodicByPeriodError,
    Options<PatchPeriodicByPeriodData>
  > = {
    mutationFn: async (localOptions) => {
...
export const postPeriodicByPeriodMutation = (
  options?: Partial<Options<PostPeriodicByPeriodData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPeriodicByPeriodResponse,
    PostPeriodicByPeriodError,
    Options<PostPeriodicByPeriodData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postPeriodicByPeriod({
        ...options,
...
export const putPeriodicByPeriodMutation = (
  options?: Partial<Options<PutPeriodicByPeriodData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PutPeriodicByPeriodResponse,
    PutPeriodicByPeriodError,
    Options<PutPeriodicByPeriodData>
  > = {
    mutationFn: async (localOptions) => {
...
export const deletePeriodicByPeriodByYearByMonthByDayMutation = (
  options?: Partial<Options<DeletePeriodicByPeriodByYearByMonthByDayData>>,
) => {
  const mutationOptions: UseMutationOptions<
    DeletePeriodicByPeriodByYearByMonthByDayResponse,
    DeletePeriodicByPeriodByYearByMonthByDayError,
    Options<DeletePeriodicByPeriodByYearByMonthByDayData>
  > = {
    mutationFn: async (localOptions) => {
...
export const getPeriodicByPeriodByYearByMonthByDayQueryKey = (
  options: Options<GetPeriodicByPeriodByYearByMonthByDayData>,
) => createQueryKey("getPeriodicByPeriodByYearByMonthByDay", options);

export const getPeriodicByPeriodByYearByMonthByDayOptions = (
  options: Options<GetPeriodicByPeriodByYearByMonthByDayData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const patchPeriodicByPeriodByYearByMonthByDayMutation = (
  options?: Partial<Options<PatchPeriodicByPeriodByYearByMonthByDayData>>,
) => {
  const mutationOptions: UseMutationOptions<
    unknown,
    PatchPeriodicByPeriodByYearByMonthByDayError,
    Options<PatchPeriodicByPeriodByYearByMonthByDayData>
  > = {
    mutationFn: async (localOptions) => {
...
export const postPeriodicByPeriodByYearByMonthByDayQueryKey = (
  options: Options<PostPeriodicByPeriodByYearByMonthByDayData>,
) => createQueryKey("postPeriodicByPeriodByYearByMonthByDay", options);

export const postPeriodicByPeriodByYearByMonthByDayOptions = (
  options: Options<PostPeriodicByPeriodByYearByMonthByDayData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: postPeriodicByPeriodByYearByMonthByDayQueryKey(options),
  });
};

export const postPeriodicByPeriodByYearByMonthByDayMutation = (
  options?: Partial<Options<PostPeriodicByPeriodByYearByMonthByDayData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostPeriodicByPeriodByYearByMonthByDayResponse,
    PostPeriodicByPeriodByYearByMonthByDayError,
    Options<PostPeriodicByPeriodByYearByMonthByDayData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postPeriodicByPeriodByYearByMonthByDay({
        ...options,
...
export const putPeriodicByPeriodByYearByMonthByDayMutation = (
  options?: Partial<Options<PutPeriodicByPeriodByYearByMonthByDayData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PutPeriodicByPeriodByYearByMonthByDayResponse,
    PutPeriodicByPeriodByYearByMonthByDayError,
    Options<PutPeriodicByPeriodByYearByMonthByDayData>
  > = {
    mutationFn: async (localOptions) => {
...
export const deleteVaultByFilenameMutation = (
  options?: Partial<Options<DeleteVaultByFilenameData>>,
) => {
  const mutationOptions: UseMutationOptions<
    DeleteVaultByFilenameResponse,
    DeleteVaultByFilenameError,
    Options<DeleteVaultByFilenameData>
  > = {
    mutationFn: async (localOptions) => {
...
export const patchVaultByFilenameMutation = (
  options?: Partial<Options<PatchVaultByFilenameData>>,
) => {
  const mutationOptions: UseMutationOptions<
    unknown,
    PatchVaultByFilenameError,
    Options<PatchVaultByFilenameData>
  > = {
    mutationFn: async (localOptions) => {
...
export const postVaultByFilenameMutation = (
  options?: Partial<Options<PostVaultByFilenameData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostVaultByFilenameResponse,
    PostVaultByFilenameError,
    Options<PostVaultByFilenameData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await postVaultByFilename({
        ...options,
...
export const putVaultByFilenameMutation = (options?: Partial<Options<PutVaultByFilenameData>>) => {
  const mutationOptions: UseMutationOptions<
    PutVaultByFilenameResponse,
    PutVaultByFilenameError,
    Options<PutVaultByFilenameData>
  > = {
    mutationFn: async (localOptions) => {
...
export const getVaultByPathToDirectoryQueryKey = (
  options: Options<GetVaultByPathToDirectoryData>,
) => createQueryKey("getVaultByPathToDirectory", options);

export const getVaultByPathToDirectoryOptions = (
  options: Options<GetVaultByPathToDirectoryData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {

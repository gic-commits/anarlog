...
pub mod minijinja {
    ...
    pub const AUTO_GENERATE_TAGS_SYSTEM: &str =
        include_str!("../minijinja/auto_generate_tags.system.jinja");
    pub const AUTO_GENERATE_TAGS_USER: &str =
        include_str!("../minijinja/auto_generate_tags.user.jinja");
    ...
    pub const POSTPROCESS_TRANSCRIPT_SYSTEM: &str =
        include_str!("../minijinja/postprocess_transcript.system.jinja");
    pub const POSTPROCESS_TRANSCRIPT_USER: &str =
        include_str!("../minijinja/postprocess_transcript.user.jinja");

...
pub use adapter::{
    AdapterKind, ArgmaxAdapter, AssemblyAIAdapter, BatchSttAdapter, DashScopeAdapter,
    DeepgramAdapter, ElevenLabsAdapter, FireworksAdapter, GladiaAdapter, HyprnoteAdapter,
    LanguageQuality, LanguageSupport, MistralAdapter, OpenAIAdapter, RealtimeSttAdapter,

...
export const commands = {
  async getEvent(id: string): Promise<Result<Event | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_event", { id }),
      };
    } catch (e) {
  ...
  async listEvents(filter: ListEventFilter | null): Promise<Result<Event[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_events", { filter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCalendar(calendarId: string): Promise<Result<Calendar | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_calendar", { calendarId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listCalendars(userId: string): Promise<Result<Calendar[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_calendars", { userId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async upsertCalendar(calendar: Calendar): Promise<Result<Calendar, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_calendar", { calendar }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async toggleCalendarSelected(trackingId: string): Promise<Result<Calendar, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|toggle_calendar_selected", {
          trackingId,
        }),
      };
    } catch (e) {
  ...
  async upsertSession(session: Session): Promise<Result<Session, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_session", { session }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async visitSession(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|visit_session", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listTemplates(): Promise<Result<Template[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_templates"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async upsertTemplate(template: Template): Promise<Result<Template, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_template", { template }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteTemplate(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_template", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async onboardingSessionId(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|onboarding_session_id"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async thankYouSessionId(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|thank_you_session_id"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listSessions(filter: ListSessionFilter | null): Promise<Result<Session[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_sessions", { filter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteSession(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_session", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getSession(filter: GetSessionFilter): Promise<Result<Session | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_session", { filter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setSessionEvent(sessionId: string, eventId: string | null): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|set_session_event", {
          sessionId,
          eventId,
        }),
      };
  ...
  async sessionAddParticipant(sessionId: string, humanId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|session_add_participant", {
          sessionId,
          humanId,
        }),
      };
  ...
  async sessionRemoveParticipant(
    sessionId: string,
    humanId: string,
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|session_remove_participant", {
          sessionId,
          humanId,
        }),
      };
  ...
  async sessionListParticipants(sessionId: string): Promise<Result<Human[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|session_list_participants", {
          sessionId,
        }),
      };
    } catch (e) {
  ...
  async sessionGetEvent(sessionId: string): Promise<Result<Event | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|session_get_event", { sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getWords(sessionId: string): Promise<Result<Word2[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_words", { sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getWordsOnboarding(): Promise<Result<Word2[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_words_onboarding"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setConfig(config: Config): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|set_config", { config }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getHuman(id: string): Promise<Result<Human | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_human", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async upsertHuman(human: Human): Promise<Result<Human, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_human", { human }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listHumans(filter: ListHumanFilter | null): Promise<Result<Human[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_humans", { filter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteHuman(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_human", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getOrganization(id: string): Promise<Result<Organization | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_organization", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteOrganization(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_organization", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getOrganizationByUserId(userId: string): Promise<Result<Organization | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|get_organization_by_user_id", {
          userId,
        }),
      };
    } catch (e) {
  ...
  async upsertOrganization(organization: Organization): Promise<Result<Organization, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_organization", {
          organization,
        }),
      };
    } catch (e) {
  ...
  async listOrganizations(
    filter: ListOrganizationFilter | null,
  ): Promise<Result<Organization[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_organizations", { filter }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listOrganizationMembers(organizationId: string): Promise<Result<Human[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_organization_members", {
          organizationId,
        }),
      };
    } catch (e) {
  ...
  async listChatGroups(sessionId: string): Promise<Result<ChatGroup[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_chat_groups", { sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listChatMessages(groupId: string): Promise<Result<ChatMessage[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_chat_messages", { groupId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createChatGroup(group: ChatGroup): Promise<Result<ChatGroup, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|create_chat_group", { group }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async upsertChatMessage(message: ChatMessage): Promise<Result<ChatMessage, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_chat_message", { message }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteChatMessages(groupId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_chat_messages", { groupId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listAllTags(): Promise<Result<Tag[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_all_tags"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listSessionTags(sessionId: string): Promise<Result<Tag[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_session_tags", { sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async assignTagToSession(tagId: string, sessionId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|assign_tag_to_session", {
          tagId,
          sessionId,
        }),
      };
  ...
  async unassignTagFromSession(tagId: string, sessionId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|unassign_tag_from_session", {
          tagId,
          sessionId,
        }),
      };
  ...
  async upsertTag(tag: Tag): Promise<Result<Tag, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|upsert_tag", { tag }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteTag(tagId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|delete_tag", { tagId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createConversation(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|create_conversation", {
          conversation,
        }),
      };
    } catch (e) {
  ...
  async listConversations(sessionId: string): Promise<Result<ChatConversation[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_conversations", { sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createMessageV2(message: ChatMessageV2): Promise<Result<ChatMessageV2, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|create_message_v2", { message }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listMessagesV2(conversationId: string): Promise<Result<ChatMessageV2[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|list_messages_v2", {
          conversationId,
        }),
      };
    } catch (e) {
  ...
  async updateMessageV2Parts(id: string, parts: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:db|update_message_v2_parts", {
          id,
          parts,
        }),
      };
...
export type ConfigAI = {
  ...
  redemption_time_ms: number | null;
};

...
export const commands = {
  async modelsDir(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|models_dir"),
      };
    } catch (e) {
  ...
  async listSupportedModel(): Promise<Result<ModelInfo[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|list_supported_model"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async isModelDownloaded(model: SupportedModel): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|is_model_downloaded", {
          model,
        }),
      };
    } catch (e) {
  ...
  async isModelDownloading(model: SupportedModel): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|is_model_downloading", {
          model,
        }),
      };
    } catch (e) {
  ...
  async downloadModel(
    ...
    channel: TAURI_CHANNEL<number>,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|download_model", {
          model,
          channel,
        }),
      };
  ...
  async startServer(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|start_server"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stopServer(): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|stop_server"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async restartServer(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|restart_server"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCurrentModel(): Promise<Result<SupportedModel, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|get_current_model"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setCurrentModel(model: SupportedModel): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|set_current_model", {
          model,
        }),
      };
    } catch (e) {
  ...
  async listDownloadedModel(): Promise<Result<SupportedModel[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|list_downloaded_model"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listCustomModels(): Promise<Result<CustomModelInfo[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-llm|list_custom_models"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type ModelSelection =
  | { type: "Predefined"; content: { key: SupportedModel } }
  | { type: "Custom"; content: { path: string } };

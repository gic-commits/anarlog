...
export const commands = {
  async setQuitHandler(reallyQuit: boolean): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:detect|set_quit_handler", { reallyQuit }),
      };
    } catch (e) {
  ...
  async setRespectDoNotDisturb(enabled: boolean): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:detect|set_respect_do_not_disturb", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setIgnoredBundleIds(bundleIds: string[]): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:detect|set_ignored_bundle_ids", { bundleIds }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listDefaultIgnoredBundleIds(): Promise<Result<string[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:detect|list_default_ignored_bundle_ids"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type DetectEvent =
  ...
  | { type: "micStopped"; apps: InstalledApp[] }

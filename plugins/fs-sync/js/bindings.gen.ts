...
export type SessionContentData = { sessionId: string; meta: SessionMetaData | null; rawMemoTiptapJson: JsonValue | null; transcript: TranscriptData | null; notes: SessionNoteData[] }

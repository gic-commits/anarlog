...
pub async fn handle_realtime_input(
    ...
    let (transcript_tx, transcript_rx) = mpsc::unbounded_channel::<StreamResponse>();
...
fn start_audio_task(
    ...
    api_key: Option<String>,
    model: String,
    transcript_tx: mpsc::UnboundedSender<StreamResponse>,
...
async fn run_tui_with_events(
    ...
    mut transcript_rx: mpsc::UnboundedReceiver<StreamResponse>,
) -> anyhow::Result<()> {
